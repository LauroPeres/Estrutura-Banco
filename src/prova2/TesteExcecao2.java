...
class A { 
    void f(int i) throws Exception { 
        try { 
            ...
            System.out.println(e.mensagem); throw e; 
        } 
...
class SidelmawException extends TabajaraException { 
    SidelmawException (String m) { 
        super(m); 
    } 
} 
class SiferrowException extends TabajaraException { 
    SiferrowException (String m) { 
        super(m); 
    } 
} 
class TabajaraException extends Exception { 
    String mensagem; 
    TabajaraException (String msg) { mensagem = msg; } }
